...
rows = cur.execute(f"SELECT * FROM angajati") # rows = generator care trebuie transf. intr-o lista sau iterat direct.
...
# name_header = ["Prenume","Nume","Salariu_brut"]

pd.DataFrame(user).to_excel('output.xlsx', header=False, index=False,)
